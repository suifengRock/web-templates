    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn default dropdown-toggle" + size + "' data-toggle='dropdown' href='bootstrap-wysihtml5.js#'>" +
            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "<div class='modal-footer'>" +
                  "<a href='bootstrap-wysihtml5.js#' class='btn default' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
                  "<a href='bootstrap-wysihtml5.js#' class='btn btn-primary green' data-dismiss='modal'>" + locale.link.insert + "</a>" +
                "</div>" +
              "</div>" +
              "</div>" +
              "</div>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              ...
              " <div class='modal-content'>" +
                ...
                "</div>" +
                "<div class='modal-footer'>" +
                  "<a href='bootstrap-wysihtml5.js#' class='btn default' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
                  "<a href='bootstrap-wysihtml5.js#' class='btn btn-primary green' data-dismiss='modal'>" + locale.image.insert + "</a>" +
                "</div>" +
              "</div>" +
              "</div>" +
              "</div>" +
        ...
        "color": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li class='dropdown'>" +
              "<a class='btn default dropdown-toggle" + size + "' data-toggle='dropdown' href='bootstrap-wysihtml5.js#' tabindex='-1'>" +
