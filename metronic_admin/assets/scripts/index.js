    ...
    return {
        ...
        initChat: function () {
            ...
            var handleClick = function (e) {
                ...
                var tpl = '';
                tpl += '<li class="out">';
                tpl += '<img class="avatar" alt="" src="http://www.keenthemes.com/preview/metronic_admin/assets/scripts/assets/img/avatar1.jpg"/>';
                tpl += '<div class="message">';
                tpl += '<span class="arrow"></span>';
                tpl += '<a href="index.js#" class="name">Bob Nilson</a>&nbsp;';
